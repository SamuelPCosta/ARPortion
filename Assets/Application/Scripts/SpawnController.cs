...
public class SpawnController : MonoBehaviour
{
    ...
    MiseEnPlaceController m_ObjectSpawner;

    /// <summary>
    /// The behavior to use to spawn objects.
    /// </summary>
    public MiseEnPlaceController objectSpawner
    {
        get => m_ObjectSpawner;
...
#else
            m_ObjectSpawner = FindObjectOfType<MiseEnPlaceController>();
#endif
    ...
    void Update()
    {
        if (Input.touchCount > 0) Debug.Log("toque detectado");
