...
{
    public class MiseEnPlaceController : MonoBehaviour
    {
        [SerializeField]
        ...
        public bool TrySpawnObject(Vector3 spawnPoint, Vector3 spawnNormal)
        {
            ...
            print(newObject.transform.GetChild(0).GetChild(0).name) ;
            newObject.transform.GetChild(0).GetChild(0).GetComponent<TextMeshProUGUI>().text = "Item "+ItemIndex;
